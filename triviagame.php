            ...
            <div class="quiz-container">
                <div class="quiz-head">
                    ...
                    <div class="quiz-score flex">
                        <span>Score:&nbsp </span><span id="total-score"></span>
                    </div>
                    <div class="quiz-timer flex">
                        <span>Timer:&nbsp </span><span id="timer"></span>
                    </div>
                </div>
                <div class="quiz-body">
...
?>
    ...
    <script src="static/js/GetTriviaData.js"></script>
